...
from scipy.integrate import odeint
N1  = 3353951. #Population of Guatemala
N2 = 1.0E05 #Population of mosquitoes
um = 0.01*7 #taken from the article 
uh = 4.3E-05*7 #taken from the article 
def f(y, t, paras):
    """
...
# measured data
data = list(np.loadtxt("chinkungunya2015.txt"))
x2_measured = list(map(lambda x: x / 539.0, data))
...
plt.tight_layout()
plt.savefig("comparacionchinkungunya.png", bbox_extra_artists=(lgd,), bbox_inches='tight')
